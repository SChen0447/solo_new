...
import { roomTemplates, FLOOR_MATERIALS, } from './roomData';
export class UIControls {
    constructor(panelId, snapshotsBarId) {
        Object.defineProperty(this, "panelContainer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "snapshotsContainer", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "furniturePanel", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: null
        ...
        Object.defineProperty(this, "maxSnapshots", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: 5
        ...
        Object.defineProperty(this, "isPanelExpanded", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: true
    ...
    bindEvents() {
        ...
        if (roomSelector) {
            roomSelector.addEventListener('change', (e) => {
                ...
                eventBus.emit(EVENTS.ROOM_CHANGE, { roomType: target.value });
            });
        }
        this.setupColorWheelEvents();
        const floorSelector = document.getElementById('floor-material-selector');
        if (floorSelector) {
        ...
        eventBus.on(EVENTS.PARAMS_UPDATE, (data) => {
            this.updateParams(data.params, data.roomType, data.furniture);
        });
        eventBus.on(EVENTS.FURNITURE_SELECT, (data) => {
            this.handleFurnitureSelect(data.furniture);
        });
        eventBus.on('snapshot:created', (snapshot) => {
            this.addSnapshot(snapshot);
        });
        eventBus.on(EVENTS.SCENE_READY, (data) => {
    ...
    updateParams(params, roomType, furniture) {
